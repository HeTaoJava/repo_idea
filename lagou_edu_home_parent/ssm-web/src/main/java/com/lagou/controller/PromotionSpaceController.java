...
public class PromotionSpaceController {
    ...
    public ResponseResult findAllPromotionSpace() {
        List<PromotionSpace> list = promotionSpaceService.findAllPromotionSpaceMapper();
    ...
    public ResponseResult savePromotionSpace(@RequestBody PromotionSpace promotionSpace) {
        if (promotionSpace.getId() == null) {//新增
            ...
            return new ResponseResult(true, 200, "响应 成功", "");
    ...
    public ResponseResult findPromotionSpaceById(int id) {
        ...
        return new ResponseResult(true, 200, "响应成 功", promotionSpace);
